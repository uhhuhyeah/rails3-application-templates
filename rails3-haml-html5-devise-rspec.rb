...
# Modifies a Rails app to use Devise with RSpec
# Usage: rails new APP_NAME -m https://github.com/uhhuhyeah/rails3-application-templates/raw/master/rails3-devise-rspec-cucumber-template.rb -T
...
@recipes = ["haml", "rspec", "guard", "devise", "add_user", "html5", "home_page", "home_page_users", "seed_database", "users_page", "html5", "cleanup", "extras", "git"]
...
## LoadSettings
if yes_wizard?("Would you like to include AppSettings?") 
  get 'https://raw.github.com/uhhuhyeah/rails3_template/master/load_settings.rb', 'config/intitializers/settings.rb'
  get 'https://raw.github.com/uhhuhyeah/rails3_template/master/settings.yml', 'config/settings.yml'
end
